...
std=[
    {"id":1,"name":"PUD","major":"T12","gpa":"3.25"},
    {"id":2,"name":"MARIO","major":"T12","gpa":"3.20"},
    {"id":3,"name":"KONDEE","major":"T12","gpa":"3.50"},
    {"id":4,"name":"KONGENG","major":"T12","gpa":"4.00"},
    {"id":5,"name":"KUMWAN","major":"T12","gpa":"3.00"}
]
@app.route("/")
def Greet():
